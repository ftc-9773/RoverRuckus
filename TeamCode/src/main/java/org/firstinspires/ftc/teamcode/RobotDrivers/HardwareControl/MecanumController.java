...
public class MecanumController {
    ...
    public MecanumController(HardwareMap hwMap) {
        ...
        driveMotors[0] = hwMap.dcMotor.get("fldrive");
        driveMotors[1] = hwMap.dcMotor.get("frdrive");
        driveMotors[2] = hwMap.dcMotor.get("bldrive");
        driveMotors[3] = hwMap.dcMotor.get("brdrive");

        for(DcMotor d:driveMotors){ d.setMode(DcMotor.RunMode.RUN_USING_ENCODER); }
    }
