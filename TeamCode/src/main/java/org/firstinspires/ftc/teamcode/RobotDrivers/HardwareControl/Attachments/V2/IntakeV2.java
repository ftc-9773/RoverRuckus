package org.firstinspires.ftc.teamcode.RobotDrivers.HardwareControl.Attachments.V2;
...
public class IntakeV2 implements Attachment {
    ...
    public IntakeV2(HardwareMap hwmp, LinearOpMode op, boolean initArmPos){
        ...
        intakeMotor = hwmp.get(DcMotorEx.class, "itMotor");
    ...
    public void debugIntakeArmServos(Telemetry telem){
        telem.addData("intakeMotor", intakeMotor.getPower());
