...
public class SamplingOrderDetector extends OpenCVPipeline {
    ...
    public Mat processFrame(Mat rgba, Mat gray){
        ...
        Core.inRange(hsv,new Scalar(24,183,128),new Scalar(40,255,255),thresholded);//TODO: TUNE THE SCALAR RANGES DEPENDING ON ACCURACY OF THE CODE
        Imgproc.dilate(thresholded,thresholded,kernel,anchor,100);
